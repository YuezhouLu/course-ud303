...
class Shortener(http.server.BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        length = int(self.headers.get('Content-length', 0)) # THis is a function taking in 2 arguments (content length and default value 0) in the BaseHTTPRequestHandler library.
        ...
        if CheckURI(longuri):
            ...
            # memory is a dictionary!!! shortname is the key and longurl is the value!!!
